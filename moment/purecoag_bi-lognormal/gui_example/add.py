...
class ModelApp:
    ...
    def addRun(self):
        ...
        print(add_fortran.main.__doc__)
        add_fortran.main.x = self.x_entry.get()
        add_fortran.main.y = self.y_entry.get()
        add_fortran.main.addtwonumbers()
        s = add_fortran.main.z
